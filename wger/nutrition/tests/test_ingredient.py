...
class IngredientRepresentationTestCase(WorkoutManagerTestCase):
    ...
    def test_representation(self):
        ...
        '''
        self.assertEqual("{0}".format(Ingredient.objects.get(pk=1)),
                         'Test ingredient 1')
...
class IngredientDetailTestCase(WorkoutManagerTestCase):
    ...
    def ingredient_detail(self, editor=False):
        ...
        response = self.client.get(reverse('nutrition:ingredient:view',
                                   kwargs={'id': 6}))
    ...
    def test_ingredient_detail_non_editor(self):
        '''
        Tests the ingredient details page as
        a logged in user without editor rights
        '''
...
class IngredientSearchTestCase(WorkoutManagerTestCase):
    ...
    def search_ingredient(self, fail=True):
        ...
        response = self.client.get(reverse('ingredient-search'),
                                   {'term': 'test'}, **kwargs)
        self.assertEqual(response.status_code, 200)
...
class IngredientValuesTestCase(WorkoutManagerTestCase):
    ...
    def calculate_value(self):
        ...
        response = self.client.get(reverse('api-ingredient-get-values',
                                   kwargs={'pk': 1}),
                                   {'amount': 1,
                                    'ingredient': 1,
                                    'unit': ''})
