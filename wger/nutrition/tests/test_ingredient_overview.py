...
class OverviewPlanTestCase(WorkoutManagerTestCase):
    ...
    def test_overview(self):
        ...
        self.assertEqual(len(response.context['ingredients_list']),
    ...
    def ingredient_overview(self, logged_in=True, demo=False, admin=False):
        ...
        if logged_in and not demo:
            self.assertNotContains(response, 'Only registered users \
                                              can do this')
    ...
    def test_ingredient_index_editor(self):
        '''
        Tests the ingredient overview page as a
    ...
    def test_ingredient_index_non_editor(self):
        '''
        Tests the overview overview page as a logged
        in user without editor rights
        '''
