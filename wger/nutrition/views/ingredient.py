...
class IngredientListView(ListView):
    ...
    def get_queryset(self):
        ...
        (the user can also want to see ingredients in
...
class IngredientCreateView(IngredientMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if self.request.user.has_perm('nutrition.add_ingredient'):
            ...
            message = _(u'''The user {0} submitted \
                        a new ingredient "{1}".'''.format(
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(IngredientCreateView,
                     self).dispatch(request, *args, **kwargs)


class PendingIngredientListView(LoginRequiredMixin,
    ...
    def get_queryset(self):
        ...
        return Ingredient.objects \
            .filter(status=Ingredient.INGREDIENT_STATUS_PENDING) \
...
def accept(request, pk):
    ...
    messages.success(request, _('Ingredient was successfully added \
...
def decline(request, pk):
    ...
    ingredient.save()
    messages.success(request, _('Ingredient was successfully \
                                 marked as rejected'))
    return HttpResponseRedirect(ingredient.get_absolute_url())
