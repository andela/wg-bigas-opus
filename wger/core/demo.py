...
def create_demo_entries(user):
    ...
    setting_list.append(Setting(set=day_set,
                        exercise=exercise,
                        reps=8, order=1))
    ...
    workout2 = Workout(user=user,
                       comment=_('Placeholder workout nr {0} for schedule')
                       .format(1))
    workout2.save()
    workout3 = Workout(user=user,
                       comment=_('Placeholder workout nr {0} for schedule')
                       .format(2))
    workout3.save()
    workout4 = Workout(user=user,
                       comment=_('Placeholder workout nr {0} for schedule')
                       .format(3))
    workout4.save()
