...
class AmazonUserAgentTestCase(WorkoutManagerTestCase):
    ...
    def test_user_agent_3rd_generation(self):
        ...
        agent = \
            "Mozilla/5.0 (Linux; Android 4.2.2; <device> Build/<build>) AppleWebKit/ "\
    ...
    def test_user_agent_2nd_generation(self):
        ...
        agent = \
            "Mozilla/5.0 (Linux; Android 4.0.3; <device> Build/<build>) AppleWebKit/<webkit>" \
    ...
    def test_user_agent_1st_generation(self):
        ...
        agent = \
            "Mozilla/5.0 (Linux; U; Android 2.3.4; <locale>; Kindle Fire Build/GINGERBREAD) "\
    ...
    def test_user_agent_generic_android(self):
        ...
        agent = \
            "Mozilla/5.0 (Linux; U; Android <version>; <locale>; Build/<build>) AppleWebKit/"\
    ...
    def test_user_agent_chrome(self):
        ...
        agent = \
            "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_0) AppleWebKit/537.36 (KHTML, like "\
...
class AndroidUserAgentTestCase(WorkoutManagerTestCase):
    ...
    def test_user_agent_old_ua(self):
        ...
        agent = \
            "Mozilla/5.0 (Linux; U; Android 4.1.1; en-gb; Build/KLP) AppleWebKit/534.30 "\
