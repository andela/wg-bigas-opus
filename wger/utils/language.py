...
def load_language(language_code=None):
    ...
    try:
        ...
        language = Language.objects.get_or_create(short_name="en")
...
def load_ingredient_languages(request):
    ...
    Additionally, if the user has selected
    on his preference page that he wishes
    to also see the ingredients in English
