...
class WgerPermission(permissions.BasePermission):
    ...
    user. For the other objects
    (system wide objects like exercises, etc.) allow
    ...
    def has_permission(self, request, view):
        ...
        The is_public flag is not present in all views, e.g.
        the special APIRoot
    ...
    def has_object_permission(self, request, view, obj):
        ...
        Perform the check
        '''
        owner_object = obj.get_owner_object() if hasattr(obj,
                                                         'get_owner_object') \
            else False
