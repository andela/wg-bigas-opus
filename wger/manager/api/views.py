...
class WorkoutViewSet(viewsets.ModelViewSet):
    ...
    def canonical_representation(self, request, pk):
        ...
        out = \
            WorkoutCanonicalFormSerializer(self.get_object()
...
class SetViewSet(WgerOwnerObjectModelViewSet):
    ...
    def get_queryset(self):
        ...
        '''
        return Set\
            .objects.filter(exerciseday__training__user=self.request.user)
...
class SettingViewSet(WgerOwnerObjectModelViewSet):
    ...
    def get_queryset(self):
        ...
        '''
        return Setting\
            .objects.filter(set__exerciseday__training__user=self.request.user)
