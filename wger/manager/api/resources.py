...
class WorkoutResource(ModelResource):
    ...
    days = fields\
        .ToManyField('wger.manager.api.resources.DayResource', 'day_set')
...
class WorkoutSessionResource(ModelResource):
    ...
    workout = fields\
        .ToOneField('wger.manager.api.resources.WorkoutResource', 'workout')
...
class ScheduleStepResource(ModelResource):
    ...
    schedule = fields\
        .ToOneField('wger.manager.api.resources.ScheduleResource', 'schedule')
...
class SetResource(ModelResource):
    ...
    def authorized_read_list(self, object_list, bundle):
        ...
        '''
        return object_list\
            .filter(exerciseday__training__user=bundle.request.user)
...
class SettingResource(ModelResource):
    ...
    def authorized_read_list(self, object_list, bundle):
        ...
        '''
        return object_list\
            .filter(set__exerciseday__training__user=bundle.request.user)
