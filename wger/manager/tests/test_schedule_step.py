...
class ScheduleStepRepresentationTestCase(WorkoutManagerTestCase):
    ...
    def test_representation(self):
        ...
        '''
        self.assertEqual("{0}".format(ScheduleStep
                                      .objects.get(pk=1)), 'A test workout')
...
class ScheduleStepTestCase(WorkoutManagerTestCase):
    ...
    def test_schedule_dates_util(self, fail=False):
        ...
        self.assertEqual(s1.get_dates(), (datetime.date(2013, 4, 21),
                                          datetime.date(2013, 5, 12)))
        self.assertEqual(s2.get_dates(), (datetime.date(2013, 5, 12),
                                          datetime.date(2013, 6, 16)))
        self.assertEqual(s3.get_dates(), (datetime.date(2013, 6, 16),
