...
class WorkoutCopyForm(Form):
    comment = CharField(max_length=100,
                        help_text=_('The goal or description \
                                     of the new workout.'),
                        required=False)
...
class SetForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['exercises'].help_text = _('You can search for more \
                                                than one exercise, '
...
class SetFormMobile(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['exercise_list'].help_text = _('You can search for more \
                                                    than one exercise, '
                                                   'they will be grouped together \
                                                    for a superset.')
