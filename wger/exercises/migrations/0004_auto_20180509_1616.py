...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='comment',
            field=models.CharField(help_text='A comment about how to correctly                                             do this exercise.', max_length=200, verbose_name='Comment'),
        ),
        migrations.AlterField(
            model_name='exerciseimage',
            name='image',
            field=models.ImageField(help_text='Only PNG and JPEG formats                                           are supported', upload_to=wger.exercises.models.exercise_image_upload_dir, verbose_name='Image'),
        ),
        migrations.AlterField(
            model_name='exerciseimage',
            name='is_main',
