...
class ExerciseResource(ModelResource):
    category = fields\
        .ToOneField('wger.exercises.api.resources.ExerciseCategoryResource',
                    'category')
    muscles = fields\
        .ToManyField('wger.exercises.api.resources.MuscleResource', 'muscles')
    muscles_secondary = fields\
        .ToManyField('wger.exercises.api.resources.MuscleResource',
                     'muscles_secondary')
    comments = fields\
        .ToManyField('wger.exercises.api.resources.ExerciseCommentResource',
                     'exercisecomment_set')
    images = fields\
        .ToManyField('wger.exercises.api.resources.ExerciseImageResource',
                     'exerciseimage_set')
    equipment = fields\
        .ToManyField('wger.exercises.api.resources.EquipmentResource',
                     'equipment')
...
class ExerciseImageResource(ModelResource):
    exercise = fields\
        .ToOneField('wger.exercises.api.resources.ExerciseResource',
                    'exercise')
    license = fields.ToOneField(LicenseResource, 'license')
    ...
    def dehydrate(self, bundle):
        ...
        for alias in aliases.all():
            ...
            thumbnails[alias] = {'url': t.get_thumbnail(aliases
                                                        .get(alias)).url,
