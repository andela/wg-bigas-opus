...
class Simple(FunkLoadTestCase):
    ...
    def test_simple(self):
        ...
        # Exercises
        self.get(server_url + '/en/exercise/overview/',
                 description='Get exercise overview')
        self.get(server_url + '/en/exercise/muscle/overview/',
                 description='Get muscle overview')
        self.get(server_url + '/de/exercise/79/view/',
        ...
        self.get(server_url +
                 '/de/nutrition/ingredient/8304/view/4-korn-waffeln/',
